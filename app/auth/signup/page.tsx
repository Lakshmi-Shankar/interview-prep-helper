    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
            ...
            <div className="absolute -bottom-6 -right-6 bg-card p-5 rounded-2xl shadow-xl border border-border animate-float">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Successful Candidates</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Benefits List */}
          <div className="mt-16 max-w-md animate-fade-in-up delay-300">
            <h3 className="text-xl font-serif text-foreground/90 mb-4 text-center">Why join us?</h3>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-foreground/80">
                ...
                <span>Record and review your performance</span>
              </div>
              <div className="flex items-center gap-3 text-foreground/80">
                <div className="w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
                  <Check className="w-3.5 h-3.5 text-primary" />
              ...
              {password.length > 0 && (
                <div className="space-y-1 pt-1">
                  <div className="flex items-center gap-2 text-xs">
                    <Check className={`w-3.5 h-3.5 transition-colors ${hasMinLength ? 'text-green-600' : 'text-muted-foreground'}`} />
                    <span className={hasMinLength ? 'text-green-600' : 'text-muted-foreground'}>At least 8 characters</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs">
                    <Check className={`w-3.5 h-3.5 transition-colors ${hasUppercase ? 'text-green-600' : 'text-muted-foreground'}`} />
                    <span className={hasUppercase ? 'text-green-600' : 'text-muted-foreground'}>One uppercase letter</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs">
                    <Check className={`w-3.5 h-3.5 transition-colors ${hasNumber ? 'text-green-600' : 'text-muted-foreground'}`} />
            ...
            <div className="space-y-2">
              ...
              {confirmPassword.length > 0 && (
                <div className="flex items-center gap-2 text-xs pt-1">
                  <Check className={`w-3.5 h-3.5 transition-colors ${passwordsMatch ? 'text-green-600' : 'text-destructive'}`} />
